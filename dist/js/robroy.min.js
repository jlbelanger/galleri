...
class RobroyAuth {
	...
	static handleLogin() {
		...
		_image__WEBPACK_IMPORTED_MODULE_2__["default"].getImages().forEach(($container) => {
			_image__WEBPACK_IMPORTED_MODULE_2__["default"].addAdminControls($container);
		});
...
class RobroyFolder {
	...
	static element(data) {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_4__["default"].modifier('folderItem', { element: $li });
	...
	static showCreateForm() {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_4__["default"].modifier('folderCreateForm', { element: $form });
	...
	static showEditForm() {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_4__["default"].modifier('folderEditForm', { element: $form });
	...
	static form(title, method, callback, id = '') {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_4__["default"].modifier('folderForm', { element: $form });
	...
	static initBreadcrumb() {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_4__["default"].modifier('breadcrumbList', { element: $ul });
	}
...
class RobroyImage {
	...
	static showCreateForm() {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_5__["default"].modifier('imageCreateForm', { element: $form });
	...
	static showEditForm(e) {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_5__["default"].modifier('imageEditForm', { element: $form });
