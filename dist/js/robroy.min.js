...
class RobroyFolder {
	...
	static form(title, method, callback, id = '') {
		...
		const $nameInput = _utilities__WEBPACK_IMPORTED_MODULE_4__["default"].addField($container, 'name', window.ROBROY.lang.fieldFolderName);
		const $idInput = _utilities__WEBPACK_IMPORTED_MODULE_4__["default"].addField($container, 'id', window.ROBROY.lang.fieldFolderId);
		...
		$nameInput.addEventListener('keyup', (e) => {
			$idInput.value = _utilities__WEBPACK_IMPORTED_MODULE_4__["default"].toSlug(e.target.value);
		});
	...
	static submitCreateFormCallback(e) {
		...
		if (!$idInput.value) {
			_errors__WEBPACK_IMPORTED_MODULE_1__["default"].add($idInput, window.ROBROY.lang.validationRequired);
			return;
		}
...
class RobroyImage {
	...
	static getImagesCallback(response) {
		const currentFolderId = _folder__WEBPACK_IMPORTED_MODULE_2__["default"].getCurrentFolderId();
		...
		_utilities__WEBPACK_IMPORTED_MODULE_5__["default"].modifier('images', { images });
	...
	static element(data, setSrc = false) {
		...
		_utilities__WEBPACK_IMPORTED_MODULE_5__["default"].modifier('imageItem', { element: $figure, image: data });
...
class Robroy {
	constructor(args) {
		...
		args.enableGrid = _utilities__WEBPACK_IMPORTED_MODULE_4__["default"].propertyExists(args, 'enableGrid') ? args.enableGrid : true;
		args.enableRewrites = _utilities__WEBPACK_IMPORTED_MODULE_4__["default"].propertyExists(args, 'enableRewrites') ? args.enableRewrites : true;
		...
		args.showAllImages = _utilities__WEBPACK_IMPORTED_MODULE_4__["default"].propertyExists(args, 'showAllImages') ? args.showAllImages : false;
		this.args = args;
